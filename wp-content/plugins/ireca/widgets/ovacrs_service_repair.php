 ...
 * @since 1.0.0
 */
class ovacrs_service_repair extends Widget_Base {
	...
	public function get_title() {
		return __( 'Service Repair', 'ireca' );
	}
	...
	protected function render() {
		...
		$html = '<div class="ireca_service_repair '.$settings['class'].'" >';
	...
	protected function _content_template() {
		?>
		<div class="ireca_service_repair {{{ settings.class }}}  " >
